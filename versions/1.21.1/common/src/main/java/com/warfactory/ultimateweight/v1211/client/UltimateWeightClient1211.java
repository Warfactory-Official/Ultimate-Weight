...
public final class UltimateWeightClient1211 {
    ...
    private static final ResourceLocation WEIGHT_ICON =
        ResourceLocation.fromNamespaceAndPath(UltimateWeightCommon.MOD_ID, "textures/gui/weight.png");
    private static final ResourceLocation STAMINA_ICON =
        ResourceLocation.fromNamespaceAndPath(UltimateWeightCommon.MOD_ID, "textures/gui/sprint.png");
