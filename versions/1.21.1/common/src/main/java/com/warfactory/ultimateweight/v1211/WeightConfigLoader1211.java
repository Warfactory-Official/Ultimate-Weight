...
public final class WeightConfigLoader1211 implements IConfigLoader {
    ...
    public WeightConfig loadBundled() {
        InputStream stream = WeightConfigLoader1211.class.getClassLoader().getResourceAsStream(FILE_NAME);
        if (stream == null) {
            return defaults();
        }
        try {
