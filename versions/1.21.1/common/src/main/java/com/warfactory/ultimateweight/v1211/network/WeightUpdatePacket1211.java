...
public final class WeightUpdatePacket1211 {
    ...
    public static WeightUpdatePacket1211 fromSnapshot(WeightSnapshot snapshot) {
        return new WeightUpdatePacket1211(
    ...
    public static WeightUpdatePacket1211 empty() {
        return new WeightUpdatePacket1211(0.0D, 0.0D, 1.0D, 1.0D, false);
    }

    public static WeightUpdatePacket1211 decode(FriendlyByteBuf buffer) {
        return new WeightUpdatePacket1211(
            buffer.readDouble(),
            buffer.readDouble(),
            buffer.readDouble(),
