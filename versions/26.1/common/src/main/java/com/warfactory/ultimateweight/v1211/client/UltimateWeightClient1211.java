...
public final class UltimateWeightClient1211 {
    private static final double EPSILON = 0.000001D;
    private static final int EXHAUSTED_HUD_COLOR = 11184810;

    private static final Identifier WEIGHT_ICON =
        Identifier.fromNamespaceAndPath(UltimateWeightCommon.MOD_ID, "textures/gui/weight.png");
    private static final Identifier STAMINA_ICON =
        Identifier.fromNamespaceAndPath(UltimateWeightCommon.MOD_ID, "textures/gui/sprint.png");
    ...
    private UltimateWeightClient1211() {
    }
    ...
    public static void renderHud(GuiGraphics graphics) {
        ...
        var latest = UltimateWeightClientState1211.latest();
        ...
        boolean exhausted = UltimateWeightClientState1211.isExhausted();
        ...
        var latestStamina = UltimateWeightClientState1211.latestStamina();
