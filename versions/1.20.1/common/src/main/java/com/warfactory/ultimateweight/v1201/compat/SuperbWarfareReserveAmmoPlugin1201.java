...
public final class SuperbWarfareReserveAmmoPlugin1201 implements WeightCompatPlugin {
    ...
    public void register(WeightCompatContext context) {
        ...
        ((CompatContext1201) context).registerInventorySource(ReserveAmmo::collect);
    }
